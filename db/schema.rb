...
ActiveRecord::Schema.define(version: 20170619233115) do
  ...
  add_index "artworks", ["artist_id", "title"], name: "index_artworks_on_artist_id_and_title", unique: true, using: :btree
  add_index "artworks", ["artist_id"], name: "index_artworks_on_artist_id", unique: true, using: :btree
